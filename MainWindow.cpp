...
MainWindow::MainWindow(): lightRotation(0.0f), 
...
void MainWindow::handleMovable(glm::mat4 vpMatrix)
{
	...
	float mousePosNormalized[] = 
	{
		mousePos[0]/screenSize[0]*2.0f-1.0f, 
...
{
	skeleton = new CSkeleton("skeleton.skl", this);
}

void MainWindow::cleanupModels()
{
	delete skeleton;
}

const double MainWindow::getDeltaTime()
{
	return deltaTime;
}
